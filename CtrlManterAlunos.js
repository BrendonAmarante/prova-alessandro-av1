...
export default class CtrlManterAlunos {
  ...
  async incluir(idJogo, precoAtual, nome, descricao, anoLancamento) {
    if(this.#status == Status.INCLUINDO) {
      try {
        let aluno = new Aluno(idJogo, precoAtual, nome, descricao, anoLancamento);
  ...
  async alterar(idJogo, precoAtual, nome, descricao, anoLancamento) {
  ...
  async excluir(idJogo) {
    if(this.#status == Status.EXCLUINDO) {
      try {
        ...
        if(aluno == null) {
          alert("Aluno com a matrícula " + idJogo + " não encontrado.");
        } else {
